...
class MoodleClient(object):
    ...
    def upload_file(self,file,evidence=None,itemid=None,progressfunc=None,args=(),token=False):
        try:
    ...
    def upload_file_blog(self,file,blog=None,itemid=None,progressfunc=None,args=(),token=False):
        try:
    ...
    def upload_file_perfil(self,file,progressfunc=None,args=(),token=False):
    ...
    def upload_file_draft(self,file,progressfunc=None,args=(),token=False):
    ...
    def upload_file_calendar(self,file,progressfunc=None,args=(),token=False):
